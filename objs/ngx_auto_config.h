#define NGX_CONFIGURE " --with-select_module --with-poll_module --with-threads --with-http_v2_module --with-http_realip_module --with-http_addition_module --with-stream=dynamic --with-pcre --with-pcre-jit --with-debug --add-module=/root/nginx-1.11.2/nginx-delay-module/ --add-module=/root/nginx-1.11.2/nginx-ey-balancer/ --with-openssl=/root/nginx-1.11.2/openssl-1.0.2f/ --with-http_stub_status_module"
